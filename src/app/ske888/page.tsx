...
const SYMBOLS = [
  {
    icon: (
      <Image src="/assets/slot/donut.svg" alt="Donut" width={64} height={64} />
    ),
    value: 2,
    name: "donut",
  },
  ...
  {
    icon: (
      <Image src="/assets/slot/bear.svg" alt="Bear" width={64} height={64} />
    ),
    value: 5,
    name: "bear",
  },
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 flex flex-col items-center">
      <div className="max-w-xl w-full mx-auto">
        <div className="text-center mb-4">
          ...
          <p className="text-white/80 text-base">Test your luck and win big!</p>
        </div>
        ...
        <div className="flex flex-col items-center">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (val === "") {
                  ...
                  const num = Math.max(1, Math.min(Number(val), money));
                  setBet(num);
                }
              }}
              onBlur={() => {
          ...
          {message && (
            <div className="mt-2 text-lg text-white font-bold">{message}</div>
          )}
          {money < bet && (
